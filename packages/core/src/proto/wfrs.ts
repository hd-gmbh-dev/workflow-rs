...
class LoadRequest$Type extends MessageType<LoadRequest> {
    constructor() {
        super("wfrs.LoadRequest", [
            { no: 1, name: "ctx", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "def", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class ListRequest$Type extends MessageType<ListRequest> {
    constructor() {
        super("wfrs.ListRequest", [
            ...
            { no: 2, name: "page", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
...
class ListResponse$Type extends MessageType<ListResponse> {
    constructor() {
        super("wfrs.ListResponse", [
            ...
            { no: 2, name: "page", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 3, name: "limit", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 4, name: "list", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => WorkflowInfo }
        ]);
    }
}
/**
...
class UpdateRequest$Type extends MessageType<UpdateRequest> {
    constructor() {
        super("wfrs.UpdateRequest", [
            ...
            { no: 3, name: "state", kind: "scalar", T: 12 /*ScalarType.BYTES*/ }
        ]);
    }
}
/**
...
class CreateEvent$Type extends MessageType<CreateEvent> {
    constructor() {
        super("wfrs.CreateEvent", [
            ...
            { no: 5, name: "key", kind: "message", T: () => ObjectId },
            { no: 6, name: "state", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
...
class CompleteEvent$Type extends MessageType<CompleteEvent> {
    constructor() {
        super("wfrs.CompleteEvent", [
            ...
            { no: 4, name: "sub", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 5, name: "key", kind: "message", T: () => ObjectId },
            { no: 6, name: "cancelled", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
}
/**
...
class ListenResponse$Type extends MessageType<ListenResponse> {
    constructor() {
        super("wfrs.ListenResponse", [
            ...
            { no: 3, name: "create_event", kind: "message", oneof: "event", T: () => CreateEvent },
            { no: 4, name: "update_event", kind: "message", oneof: "event", T: () => UpdateEvent },
            { no: 5, name: "complete_event", kind: "message", oneof: "event", T: () => CompleteEvent }
        ]);
    }
}
/**
...
export const Workflow = new ServiceType("wfrs.Workflow", [
    ...
    { name: "Listen", serverStreaming: true, options: {}, I: ListenRequest, O: ListenResponse }
]);
