...
export interface IWorkflowClient {
    ...
    load: (
        input: LoadRequest,
        options?: RpcOptions,
    ) => UnaryCall<LoadRequest, OptLoadResponse>;
    /**
    ...
    isSync: (
        input: IsSyncRequest,
        options?: RpcOptions,
    ) => UnaryCall<IsSyncRequest, IsSyncResponse>;
    /**
    ...
    create: (
        input: CreateRequest,
        options?: RpcOptions,
    ) => UnaryCall<CreateRequest, CreateResponse>;
    /**
    ...
    complete: (
        ...
        options?: RpcOptions,
    ) => UnaryCall<CompleteRequest, CompleteResponse>;
    /**
    ...
    listen: (
        input: ListenRequest,
        options?: RpcOptions,
    ) => ServerStreamingCall<ListenRequest, ListenResponse>;
}
/**
 * @generated from protobuf service wfrs.Workflow
 */
export class WorkflowClient implements IWorkflowClient, ServiceInfo {
    ...
    load(
        ...
        return stackIntercept<LoadRequest, OptLoadResponse>(
            'unary',
            this._transport,
            method,
            opt,
    ...
    isSync(
        ...
        const opt = this._transport.mergeOptions(options);
        return stackIntercept<IsSyncRequest, IsSyncResponse>(
            'unary',
            this._transport,
            method,
            opt,
    ...
    create(
        ...
        const opt = this._transport.mergeOptions(options);
        return stackIntercept<CreateRequest, CreateResponse>(
            'unary',
            this._transport,
            method,
            opt,
    ...
    complete(
        ...
        const opt = this._transport.mergeOptions(options);
        return stackIntercept<CompleteRequest, CompleteResponse>(
            'unary',
            this._transport,
            method,
            opt,
    ...
    listen(
        ...
        const opt = this._transport.mergeOptions(options);
        return stackIntercept<ListenRequest, ListenResponse>(
            'serverStreaming',
            this._transport,
            method,
            opt,
